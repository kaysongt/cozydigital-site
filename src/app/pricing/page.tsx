...
const buildItems = [
  ...
  { service: "AI Search Visibility (GEO) Setup: structured data + answer content so ChatGPT, Perplexity & Google AI can recommend you", price: "$400" },
...
const retainerItems = [
  ...
  { service: "AI Search Visibility (GEO) Monitoring: we track how AI describes your business and keep answer content current", price: "$100/mo" },
    ...
    <main className="min-h-screen px-6 py-12 text-zinc-100">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <PricingTable items={buildItems} total="$3,400" totalLabel="Full Build Total" />
        ...
        <div className="mb-12">
          ...
          <PricingTable items={retainerItems} total="$1,000/mo" totalLabel="Monthly Retainer Total" />
        </div>
        ...
        <div className="rounded-2xl border border-cyan-300/20 bg-cyan-500/10 p-6 text-center">
          <p className="mb-4 text-sm text-zinc-300">
            ...
            <Link href="/free-audit/#audit-form" className="font-semibold text-cyan-300 underline underline-offset-2 hover:text-cyan-100">Digital Presence Audit</Link>{" "}
