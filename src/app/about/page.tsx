    ...
    <main className="min-h-screen px-6 py-12 text-zinc-100">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed">
          ...
          <p>We don&apos;t sell bloated strategy decks or 6-month retainers for work that should take 2 weeks. We look at your homepage, your content, your booking path, and your CTAs like a customer would, then we fix what&apos;s blocking the conversion.</p>
